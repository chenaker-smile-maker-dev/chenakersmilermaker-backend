...
class AppointmentListMonthViewWidget extends CalendarWidget
{
    protected string $view = 'panels.widgets.appointment-list-month-view';

    protected int|string|array $columnSpan = 'full';

    protected ?string $locale = 'en';

    protected CalendarViewType $calendarView = CalendarViewType::ListMonth;
